...
function About() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold text-center text-blue-600 mb-12">About AI Buddy</h1>
      ...
      <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
        ...
        <p className="text-lg text-gray-600 mb-6">
          AI Buddy was created to help kids understand artificial intelligence in a fun and safe way.
          We believe that learning about AI early helps prepare children for a future where AI is part of everyday life.
        </p>
      ...
      >
        ...
        <p className="text-gray-600">
          Have questions or suggestions? Ask a parent or teacher to help you reach out to us!
        </p>
      </motion.div>
    </div>
  );
